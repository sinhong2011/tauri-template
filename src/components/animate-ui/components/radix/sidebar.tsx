  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative z-10 hidden h-full w-(--sidebar-width) transition-[width] duration-400 ease-[cubic-bezier(0.75,0,0.25,1)] md:flex',
...
function SidebarInset({ className, ...props }: SidebarInsetProps) {
  return (
    <main
      ...
      className={cn(
        'bg-background flex-1 max-h-full overflow-auto',
...
function SidebarContent({ className, ...props }: SidebarContentProps) {
  return (
    <div
      ...
      className={cn(
        'flex h-0 min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden',
        className
      )}
      {...props}
    />
